...
export default function Page() {
  ...
  return (
    <Dialog sx={{ minHeight: '300' }} fullWidth maxWidth="sm" open onClose={() => router.push('/')}>
      <ReactSpring.FadeIn active={!!newInterior?.progress && newInterior.progress < 100}>
      ...
      <ReactSpring.FadeIn active={!newInterior || newInterior.progress === 100}>
        ...
        <ColorButton sx={{ textTransform: 'none' }}>Confirm your email to use Interior AI</ColorButton> */}
          ...
          watermark upgrade to Pro and you get your own private workspace. */}
              ...
              <p className={styles.sub_info}>
                ...
                gives you more creative ideas. A good idea is to use Interior Design mode and then Mix w/ Original to
                get the original auto masked background back.
              </p>
